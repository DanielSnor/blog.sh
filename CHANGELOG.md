...
- **A draft's properties say where to read it.** The preview address stands on the screen, and `[m]` shows its QR code for a phone -- until now only the dialog after a save did, so reading a draft on a phone meant opening it in the editor first.
