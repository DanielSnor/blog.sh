...
| The site looks wrong, or you want to change how it looks | `./style.sh` -- a menu over the palette, banner, about, footer, social icons, sidebar widgets, fonts and analytics. It ends by offering a rebuild, since appearance is the one thing a diff can't show you. |
