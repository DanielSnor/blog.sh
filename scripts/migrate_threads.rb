...
# for JSON. Unpack the ZIP and point this at the directory. Your own
# standalone posts import with their media from the archive; replies
# to other people's threads are skipped and counted. Bare URLs in the
# text become real links.
...
abort("#{dir} has no threads_and_replies.json -- point this at the unpacked JSON export") unless Import::Threads.posts_file(dir)
