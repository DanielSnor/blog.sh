...
# Download your information -- ask for JSON. Unpack the ZIP and point
...
abort("#{dir} has no your_posts*.json -- point this at the unpacked JSON export (not the HTML one)") unless Import::Facebook.posts_dir(dir)
